...
#Used to determine secondary exposure within classroom (0.035 * 0.6)
HEAVY_EXPOSURE_ODDS = 0.014

def simulate_two(schools, days_in_sim, num_sims):
  print("Beginning simulation of Scenario 2")
  sim_ct = 1
  days = days_in_sim
  with open('sickness_sim_2.csv', mode = 'w') as sick_file:
      ...
      #         print("Teacher",teach.ID, "is now sick")
        ...
        #           print("Student", stud.ID, "has been exposed")
                    if(random.random() < HEAVY_EXPOSURE_ODDS):
                      ...
                      if(testing_flag and stud.classroom in school.symptomatic_classrooms):
          ...
          #            print("Student", stud.ID, "is now sick")
            ...
            #       print("Teacher", teach.ID, "has been exposed")
                    if(random.random()< HEAVY_EXPOSURE_ODDS):
                      ...
                      if(testing_flag and teach.classroom in school.symptomatic_classrooms):
                        teach.in_school = False
          school.symptomatic_classrooms = []
